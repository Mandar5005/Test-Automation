...
public class ITAFWebDriverPAS extends ITAFWebDriver {
	...
	private final static Logger log = LogManager.getLogger(ITAFWebDriverPAS.class.getName());
	...
	protected void init() throws IOException {
		...
		try {
			...
			try {
				String visualreportUtility = Config.createVisualReportUtility;
				log.info("Visual Report Utility : " + visualreportUtility);

				if (visualreportUtility.equalsIgnoreCase("TRUE")) {
